...
public class SolicitudCatastral {
	
	public static final String ID_PROCESS = "ProductosCatastrales.ProcesoProductosCatastrales";
	public static final String ID_CONTAINER = "NucleoPredial";
