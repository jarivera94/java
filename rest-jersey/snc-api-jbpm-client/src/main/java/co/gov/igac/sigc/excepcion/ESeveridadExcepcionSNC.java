 ...
 */
public class ESeveridadExcepcionSNC {
	...
	/**
	 * En el caso que la excepción no cause fallos en el componente del sistema y siga funcionando
	 * sin problemas. Esta severidad debe usarse en caso que la excepción presentada no afecte el
	 * resultado final que el usuario o cliente del sistema está esperando.
	 */
